...
$sql_profile="select * from $table_admin where user_id='$user_id1' ";
  ...
  <div class="row-fluid">
     ...
     <?php
	  ...
	  <div style="margin:10px 0;text-align:center;">
       <a href="profile_bio.php">
       <button class="btn  btn-success btn-lg " type="button" style="background-color: rgb(19, 207, 109);">Update Profile</button></a>
       </div>
</div>
</div>
</div>
